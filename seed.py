...
# g1 = Game(game_id="fd55db2fa9ee5be1f108be5151e2ecb0", start_time="Oct 24, 2023 @ 04:30 PM", day="Nov 27", home_team="Denver Nuggets", away_team="Los Angeles Lakers", home_ml_price=-205, away_ml_price=170, home_PS=-5, away_PS=5, home_PS_price=-110, away_PS_price=-110, over_under=227.0, over_under_price=-110)
